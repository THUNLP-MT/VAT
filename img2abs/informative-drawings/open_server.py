...
def opensketch_style_transfer(input_image):
    global models
...
demo = gr.Interface(
    fn=opensketch_style_transfer,
    inputs=gr.Image(type="pil", label="Input Image"),
    outputs=gr.Image(type="pil", label="Opensketch Style Output"),
    title="Opensketch Style Transfer",
    description="Upload an image to convert it to opensketch style. The output will maintain the original image dimensions.",
    examples=[
        ["example1.jpg"],
        ["example2.jpg"]
...
if __name__ == "__main__":
    demo.launch(share=True, server_name="0.0.0.0", server_port=8086)